...
describe("test network providers on devnet: Proxy and API", function () {
    ...
    let carol = new Address("moa1k2s324ww2g0yj38qn2ch2jwctdy8mnfxep94q9arncc6xecg3xaqhr5l9h");
    let dan = new Address("moa1kyaqzaprcdnv4luvanah0gfxzzsnpaygsy6pytrexll2urtd05tsg5l8qw");
    const MAX_NUMBER_OF_ITEMS_BY_DEFAULT = 20;

    let apiProvider: INetworkProvider = new ApiNetworkProvider("https://devnet-api.dharitri.com", { timeout: 10000 });
    let proxyProvider: INetworkProvider = new ProxyNetworkProvider("https://devnet-gateway.dharitri.com", { timeout: 10000 });
        ...
        const txs = [
            {
                toSendable: function () {
                    return {
                        "nonce": 42,
                        "value": "1",
                        "receiver": "moa1testnlersh4z0wsv8kjx39me4rmnvjkwu8dsaea7ukdvvc9z396qfw237w",
                        "sender": "moa15x2panzqvfxul2lvstfrmdcl5t4frnsylfrhng8uunwdssxw4y9s3q72vs",
                        "gasPrice": 1000000000,
                        "gasLimit": 50000,
                        "chainID": "D",
                        "version": 1,
    ...
    it("should have same response for queryContract()", async function () {
        ...
        let query = new MockQuery({
            address: new Address("moa1qqqqqqqqqqqqqpgqfzydqmdw7m2vazsp6u5p95yxz76t2p9rd8ssz682hq"),
            func: "getSum"
        });
        ...
        const transaction = {
            toSendable: function () {
                return {
                    ...
                    "sender": "moa1zztjf9fhwvuvquzsllknq4qcmffwad6n0hjtn5dyzytr5tgz7uaszrs8ls",
                    "gasPrice": 1000000000,
                    "gasLimit": 50000,
                    "chainID": "D",
                    "version": 2,
